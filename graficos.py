...
output_graph = "test_results_grouped_bar_chart_spaced_color.png"  # Nome do arquivo do gráfico gerado
...
colors = plt.cm.get_cmap("tab20", 15)  # Garantir 15 cores únicas
